exports.adminContactNotificationEmail = (
    email,
    firstname,
    lastname,
    message,
    ...
    <body>
        <div class="container">
            ...
            <div class="body">
                <p>A user has submitted the contact form on StudyNotion.</p>
    ...
    <body>
        <div class="container">
            ...
            <div class="support">If you have any further questions or need immediate assistance, please feel free to reach
                out to us at <a href="mailto:${supportEmail}">${supportEmail}</a>. We are here to help!</div>
        </div>
    </body>
